...
void bottomView(Node* root) {
    ...
    map<int, int> bottomViewMap;  // Store the bottom view nodes at each vertical level.
    ...
    while (!q.empty()) {
        ...
        // Update the map value for the current horizontal distance.
